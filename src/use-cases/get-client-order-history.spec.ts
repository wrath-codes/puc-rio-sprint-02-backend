...
let sut: GetClientOrderHistory;

describe("Get Client Order History Use Case", () => {
  beforeEach(() => {
  ...
  it("should be able to get a client order history with dishes", async () => {
  ...
  it("should not be able to get a client order history with dishes if client does not exists", async () => {
    await expect(
      sut.execute({
